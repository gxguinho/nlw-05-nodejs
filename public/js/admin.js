...
function call(id){
  ...
  socket.emit("admin_list_messages_by_user",
    params,  messages =>{
      ...
      messages.forEach(message =>{
        ...
        if(message.admin_id === null){
          ...
          createDiv.innerHTML += `<span class="admin_date">${dayjs(message.created_at).format("DD//MM/YYYY HH:ss")}</span>`;
        }else{
...
function sendMessage(id){
  ...
  createDiv.innerHTML += `<span class="admin_date">${dayjs()}</span>`;
...
socket.on("admin_receive_message", (data) => {
  ...
  createDiv.innerHTML += `<span class="admin_date">${dayjs(data.message.created_at).format("DD//MM/YYYY HH:ss")}</span>`;
